-- Adds cash walk-in checkout while preserving the marketplace checkout flow.
-- Run after 20260721040000_marketplace_pos.sql.
...
begin
  ...
  insert into public.sales (
    ...
    v_user_id,
    'draft',
    case when p_channel = 'walk_in' then 'cash' else 'marketplace' end,
    p_channel,
  ...
  loop
    ...
    insert into public.stock_movements (
      ...
      v_sale_id,
      case
        when p_channel = 'walk_in' then 'Walk-in sale ' || v_receipt_number
